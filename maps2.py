...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/static/CACHE/css/ec1e06dca4f2.css" type="text/css" /><link rel="stylesheet" href="/static/CACHE/css/2c191bb09ae8.css" type="text/css" media="screen" />

        <!-- Le javascript -->
        <script type="text/javascript">
            var Anywhere = {};
            Anywhere.urls = {};
            Anywhere.csrfToken = "1USkP5sAovb38tK9920VC6nIjUw2lQku";
        </script>
        <script type="text/javascript" src="/static/CACHE/js/f8051f8ef309.js"></script>
...
<li class="visible-xs"><a href="https://blog.pythonanywhere.com/" class="blog_link">Blog</a></li>
  ...
  <form class="form" action="" method="post"><input type='hidden' name='csrfmiddlewaretoken' value='1USkP5sAovb38tK9920VC6nIjUw2lQku' />
    <table>
...
<p class="form-group">
  <input autocapitalize="off" autocorrect="off" class="form-control" id="id_auth-username" maxlength="100" name="auth-username" placeholder="Username or email address" tabindex="1" type="text" />
  <span class="help-block">
    No account? <a href="/pricing/" id="id_signup_link">Sign up here!</a>
  </span>
</p>
<p class="form-group">
  <input class="form-control" id="id_auth-password" name="auth-password" placeholder="Password" tabindex="2" type="password" />
  <span class="help-block">
